...
# Deserialization using pickle.load to read from a file
file_handler= open('data.dat', 'rb')
loaded_item1 = pickle.load(file_handler)
print("\nLoaded Item from file:")
print(loaded_item1)

# Deserialization using pickle.loads to read from a string
loaded_item2 = pickle.loads(serialized_data)
print("\nLoaded Item from string:")
print(loaded_item2)
