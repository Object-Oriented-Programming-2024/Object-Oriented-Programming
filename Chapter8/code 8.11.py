...
# Spliting the dataframe into features and target variables
y = df1["Outcome"]
...
# Applying the K-Neighbors Classifier
from sklearn.neighbors import KNeighborsClassifier
model= KNeighborsClassifier()
# Various settings for the hyperparameter n_neighbors
hyperparams =  {'n_neighbors': [3, 5, 7, 9, 11]}
